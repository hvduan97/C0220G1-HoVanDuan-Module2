...
public class BlogServiceImpl implements BlogService {
    ...
    @Override
    public Page<Blog> findAllByCategory_IdContaining(String id, Pageable pageable) {
        return blogRepository.findAllByCategory_IdContaining(id, pageable);
    }
    ...
    @Override
    public Page<Blog> findAllByCategory_NameContaining(String name, Pageable pageable) {
        return blogRepository.findAllByCategory_NameContaining(name,pageable);
    }
}
