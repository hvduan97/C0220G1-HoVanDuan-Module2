...
public class ProductController {
    ...
    public String search(@RequestParam String searching,Model model){
        String abc=productService.removeDuplicateWhitespace(searching);
        boolean a=productService.searchName(productService.returnMap(),abc);
        String result="";
        if (a){
            result+="Tim Thay";
        }
        ...
        model.addAttribute("abcd",result);
//        String result=productService.runningMap(searching);
//        model.addAttribute("abcd",result);
        return "viewsearch";
    }
